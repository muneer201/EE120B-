...
enum states { INIT, WAIT, LED, SNOOZE, DANGER} state; //TODO: finish the enum for the SM


void Tick() {
 //TODO: declare your static variables here or declare it globally
 
 bright_daylight = ADC_read(2);
 dark = (bright_daylight < 100);
